        ...
        protected override async Task<TaskModuleResponse> OnTeamsTaskModuleFetchAsync(ITurnContext<IInvokeActivity> turnContext, TaskModuleRequest taskModuleRequest, CancellationToken cancellationToken)
        {
            ...
            switch (command.ToUpperInvariant())
            {
                ...
                case BotCommands.ShowFavoriteTaskModule:
                    ...
                    return this.GetTaskModuleResponse(string.Format(CultureInfo.InvariantCulture, "{0}/AddFavourite?telemetry={1}&token={2}&replyTo={3}", this.appBaseUri, this.instrumentationKey, token, activityReferenceId), Strings.AddFavTaskModuleSubtitle);
                ...
                case BotCommands.ShowOtherRoomsTaskModule:
                    activityReferenceId = postedValues.ActivityReferenceId;
                    return this.GetTaskModuleResponse(string.Format(CultureInfo.InvariantCulture, "{0}/OtherRoom?telemetry={1}&token={2}&replyTo={3}", this.appBaseUri, this.instrumentationKey, token, activityReferenceId), Strings.AnotherRoomTaskModuleSubtitle);
